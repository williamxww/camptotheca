...
public class LogicalPlan {
     ...
     * @throws ParsingException if either of the fields is ambiguous, or is not
     *         in one of the tables added via {@link #addScan}
     */
     ...
     * 
     * @param table the id of the table accessed by the plan (can be resolved to
     *        a DbFile using {@link Catalog#getDatabaseFile}
     ...
     *         name.
     * @throws ParsingException if the field cannot be found in any of the
     *         tables, or if the field is ambiguous (appears in multiple tables)
     */
     ...
     * 
     * @param t The transaction that the returned DbIterator will run as a part
     *        of
