...
import com.bow.camptotheca.zql.ParseException;
import com.bow.camptotheca.zql.TokenMgrError;
import com.bow.camptotheca.zql.ZConstant;
import com.bow.camptotheca.zql.ZDelete;
import com.bow.camptotheca.zql.ZExp;
import com.bow.camptotheca.zql.ZExpression;
import com.bow.camptotheca.zql.ZFromItem;
import com.bow.camptotheca.zql.ZGroupBy;
import com.bow.camptotheca.zql.ZInsert;
import com.bow.camptotheca.zql.ZOrderBy;
import com.bow.camptotheca.zql.ZQuery;
import com.bow.camptotheca.zql.ZSelectItem;
import com.bow.camptotheca.zql.ZStatement;
import com.bow.camptotheca.zql.ZTransactStmt;
import com.bow.camptotheca.zql.ZqlParser;
...
public class Parser {
    ...
    void processExpression(TransactionId tid, ZExpression wx, LogicalPlan lp) throws ParsingException {
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
            throws TransactionAbortedException, DbException, IOException, ParsingException, ParseException {
        ...
        if (physicalPlan != null) {
            Class<?> c;
            try {
                c = Class.forName("com.bow.camptotheca.OperatorCardinality");
                ...
                c = Class.forName("com.bow.camptotheca.QueryPlanVisualizer");
            ...
            for (ZExp e : values) {
                ...
                if (zc.getType() == ZConstant.NUMBER) {
                    ...
                    if (td.getFieldType(i) != Type.STRING_TYPE) {
                        throw new ParsingException("Value " + zc.getValue() + " is a string, expected an integer.");
                    }
    ...
    public LogicalPlan generateLogicalPlan(TransactionId tid, String s) throws ParsingException {
        ...
        try {
            ...
            if (s instanceof ZTransactStmt)
                ...
                try {
                    ...
                    if (a instanceof ParsingException || a instanceof ParseException)
