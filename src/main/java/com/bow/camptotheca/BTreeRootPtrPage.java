...
/**
 * BTree Root 的指针页，包含了root page的页号(int) root page的类型(byte) 第一个header页的页号(int)
 *
 * @see BufferPool
 */
public class BTreeRootPtrPage implements Page {
    ...
    /**
     * 此page一共只有9个字段，root page的页号(int) root page的类型(byte) 第一个header页的页号(int)
     */
    ...
    /**
     * page number of the first header page
     */
    private int header;
