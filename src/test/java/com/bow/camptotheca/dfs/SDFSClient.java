...
import com.bow.camptotheca.dfs.FileServer.Message;
import com.bow.camptotheca.dfs.FileServer.MessageType;
...
public class SDFSClient {
    ...
    private static void listfiles() {
        ...
        try {
            ...
            soOut.println(com.bow.camptotheca.dfs.ElectionService.Message
                    .MessageBuilder
                    .buildListMessage(InetAddress.getLocalHost().getHostName()));
            soOut.flush();
            if (soIn.hasNext()) {
                com.bow.camptotheca.dfs.ElectionService.Message reply= com.bow.camptotheca.dfs.ElectionService
                        .Message
    ...
    private static void getOperation(Scanner soIn, PrintWriter soOut, String sdfsfname, String destfname) {
        soOut.println(com.bow.camptotheca.dfs.ElectionService.Message
                ...
                .toString());
        soOut.flush();
        com.bow.camptotheca.dfs.ElectionService.Message reply= com.bow.camptotheca.dfs.ElectionService.Message
                .extractMessage(soIn.next());
        if (reply.messageParams[0].equals("NOT_OK")) {
